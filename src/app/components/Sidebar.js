    ...
    <div className={styles.sidebar}>
      ...
      <nav>
        <ul className={styles.navList}>
          <li><Link href="/dashboard" className={styles.navItem}><span className={styles.icon}>🏠</span>Overview</Link></li>
          ...
          <li><Link href="/dashboard/api-playground" className={styles.navItem}><span className={styles.icon}>⚙️</span>API Playground</Link></li>
